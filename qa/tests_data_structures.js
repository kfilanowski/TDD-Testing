...
suite("Test data_structures.js file", function() {
  ...
  **/
  ...
  suite("Unit tests for wordCount function", function() {
    test("Test if rbbrrg_input_text is {red: 3, blue: 2, green: 1}.",
     function() {
    ...
    test("Test if newline_input_text is {red: 3, blue: 2, green: 1}.",
    function() {
      assert.deepEqual(data_structures.wordCount(dataD),
                      {red: 3, blue: 2, green: 1});
    });
  }); //END WORDCOUNT TESTS
  ...
  suite("Unit tests for wordFreq function", function() {
    test("Test if rbbrrg_input_text is {red: 0.5, blue: 1/3, green: 1/6}",
     function() {
      assert.deepEqual(data_structures.wordFreq(dataA),
                      {red: 0.5, blue: 1/3, green: 1/6});
    });
    ...
    test("Test if newline_input_text is {red: 1/2, blue: 1/3, green: 1/6}",
     function() {
      assert.deepEqual(data_structures.wordFreq(dataD),
                      {red: 0.5, blue: 1/3, green: 1/6});
    });
  }); //END WORDFREQ tests
  ...
  suite("Unit tests for CondWordCount function", function() {
    test("Test if rbbrrg_input_text is {red: {blue: 1, green: 1, red: 1}, "
         + " blue: {blue: 1, red: 1}, green: {red: 1}}.", function() {
      assert.deepEqual(data_structures.condWordCount(dataA),
                      {red: {blue: 1, green: 1, red: 1},
                       blue: {blue: 1, red: 1},
                       green: {red: 1}});
    });

    test("Test if rbrbb_input_text is {red: {blue: 2}, "
         + " blue: {blue: 1, red: 2}}.", function() {
      assert.deepEqual(data_structures.condWordCount(dataB), {red: {blue: 2},
                       blue: {blue: 1, red: 2}});
    });

    test("Test if empty_input_text is empty.",function() {
      assert.strictEqual(data_structures.condWordCount(dataC),
                        "Input is empty");
    });

    test("Test if newline_input_text is {red: {blue: 1, green: 1, red: 1},"
         + " blue: {blue: 1, red: 1}, green: {red: 1}}.", function() {
      assert.deepEqual(data_structures.condWordCount(dataD),
                      {red: {blue: 1, green: 1, red: 1},
                      blue: {blue: 1, red: 1},
                      green: {red: 1}});
    });
  ...
  suite("Unit tests for condWordFreq function", function() {
    test("Test if rbbrrg_input_text is {red: {blue: 1/3, green: 1/3, red: 1/3}"
         + ", blue: {blue: 0.5, red: 0.5}, green: {red: 1}}.", function() {
      assert.deepEqual(data_structures.condWordFreq(dataA),
                      {red: {blue: 1/3, green: 1/3, red: 1/3},
                       blue: {blue: 0.5, red: 0.5},
                       green: {red: 1}});
    });

    test("Test if rbrbb_input_text is {red: {blue: 1},"+
         "blue: {blue: 1/3, red: 2/3}}.", function() {
      assert.deepEqual(data_structures.condWordFreq(dataB),
                      {red: {blue: 1},
                      blue: {blue: 1/3, red: 2/3}});
    });
    ...
    test("Test if newline_input_text is {red: {blue: 1/3, green: 1/3, red: 1/3}"
         + ", blue: {blue: 0.5, red: 0.5}, green: {red: 1}}.", function() {
      assert.deepEqual(data_structures.condWordFreq(dataD),
                      {red: {blue: 1/3, green: 1/3, red: 1/3},
                      blue: {blue: 0.5, red: 0.5},
                      green: {red: 1}});
    });
  ...
  suite("Unit tests for removeNonAlpha function", function() {
    test("Testing if rbbrrg_input_text is \"red blue blue red red green\"",
    function() {
      assert.strictEqual(data_structures.removeNonAlpha(dataA),
                         "red blue blue red red green");
    });

    test("Testing if rbrbb_input_text is \"red blue red blue blue\"",
    function() {
      assert.strictEqual(data_structures.removeNonAlpha(dataB),
                         "red blue red blue blue");
    });

    test("Testing if empty_input_text is an empty file",
    function() {
      assert.strictEqual(data_structures.removeNonAlpha(dataC), "");
    });

    test("Testing if newline_input_text is \"red blue blue red red green\"",
    function() {
      assert.strictEqual(data_structures.removeNonAlpha(dataD),
                         "red blue blue red red green");
    });
